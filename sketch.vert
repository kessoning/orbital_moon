...
/*
 * My first test on VEDA for Atom.
 * First attempt to code a vertex shader in vertexshadertart.com style
 *
 * Hack it, destroy it
 * Running smoothly on an nVidia 980GT, while changing values on the fly
 *
 * More info at https://kesson.io
 * info@kesson.io
 *
 */
...
// Based on my sketch: https://www.vertexshaderart.com/art/4FQ77YanjkTRoSWip
// Which is based on https://www.vertexshaderart.com/art/nL6YpkW8YvGKNEKtj
...
void main() {
  ...
  mat4 rotation = rotateY(time*0.025);
  ...
  v_color = vec4(1.0, 1.0, 0.85, 0.05);
}
